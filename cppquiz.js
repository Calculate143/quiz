...
const questions = [
    ...
    {
        question: "What is the correct syntax to include the iostream header?",
        options: [
            "import iostream;",
            "#include <iostream>",
            "using iostream;",
    ...
    {
        question: "Which keyword ensures inheritance is private by default?",
        options: [
            "struct",
            "class",
            "inherit",
...
function printCertificate() {
    ...
    printWindow.document.write(`
        <html>
<head>
    <title>C++ Quiz Certificate</title>
    ...
    <div class="certificate-container">
        <div class="certificate">
            ...
            <div class="header">
                ...
                <h2 class="subtitle">C++ Quiz Mastery</h2>
            </div>
            <div class="content">
                <div class="watermark">CERTIFIED</div>
                <p class="completion-text">This is to certify that</p>
                <h3 class="student-name">${username}</h3>
                <p class="completion-text">has successfully completed the C++ Quiz</p>
